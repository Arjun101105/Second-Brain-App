...
export const LandingPage = () => {
  return (<div>
    <div className="flex justify-end gap-4 p-2">
        <Button variant="primary" size="md" text="Login" onClick={() => window.location.href = `${API_URL}/api/v1/signin`}></Button>
        <Button variant="primary" size="md" text="Sign Up" onClick={() => window.location.href = `${API_URL}/api/v1/signup`}></Button> 
        </div>
